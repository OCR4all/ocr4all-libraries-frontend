...
<template>
  <div
    class="group flex flex-col justify-between rounded-md bg-white p-5 shadow-md hover:cursor-pointer hover:bg-blue-700 dark:bg-zinc-800 hover:dark:bg-blue-800 xl:flex-row"
