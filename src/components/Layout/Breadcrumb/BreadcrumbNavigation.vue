...
<template>
  <nav
    ...
    class="hidden justify-between rounded-lg border border-gray-200 bg-surface-0 px-4 py-3 dark:border-gray-700 dark:bg-surface-800 lg:flex lg:border-none lg:bg-surface-0 lg:p-0 lg:dark:bg-surface-900"
