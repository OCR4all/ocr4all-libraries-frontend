...
<template>
  ...
  >
    <section id="stepper" class="p-20">
      <div
        class="relative after:absolute after:inset-x-0 after:top-1/2 after:block after:h-0.5 after:-translate-y-1/2 after:rounded-lg after:bg-gray-200 dark:after:bg-gray-500"
      >
    ...
    <section
      v-if="step === 0"
      class="flex items-center justify-center dark:text-gray-100 sm:p-24"
    >
