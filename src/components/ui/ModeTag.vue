...
<template>
  <div
    class="align-center flex cursor-pointer gap-x-2 rounded bg-blue-100 px-2.5 py-2 text-sm font-bold text-surface-700 dark:bg-blue-900 dark:text-surface-100"
    @click="toggle"
  >
  ...
  <Popover ref="popover">
    <div class="flex flex-col gap-y-1">
      <Button severity="primary" :disabled="true" text>
        <div
          class="flex w-full justify-start space-x-2 text-black dark:text-white"
        >
      ...
      <Button
        v-show="props.mode !== 'admin' && authStore.isAdmin"
        severity="primary"
        text
