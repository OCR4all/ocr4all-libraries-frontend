...
<template>
  <div class="flex h-screen flex-col bg-gray-100 dark:bg-zinc-900">
    <AppTopbar
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <main
        class="mx-auto flex flex-1 justify-center overflow-y-auto bg-gray-100 px-8 py-8 dark:bg-zinc-900 2xl:px-24"
      >
