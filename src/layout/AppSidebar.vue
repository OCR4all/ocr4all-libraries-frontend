...
<template>
  <div
    class="m-1 hidden flex-none lg:block overflow-y-auto h-screen"
    :class="[maximized ? 'w-64' : 'w-22']"
  >
    <div
      class="mx-6 my-4 flex justify-between content-between"
    ...
    <div class="grid content-between" :class="[maximized ? 'lg:h-[calc(100vh-7rem)]' : 'lg:h-[calc(100vh-10rem)]']">
