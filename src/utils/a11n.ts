...
export function setFont(entry: IEntry) {
  ...
  document.documentElement.style.setProperty("--font-family", entry.value);
}
...
export function setFontFromStorage() {
  ...
  document.documentElement.style.setProperty("--font-family", size.value.value);
}

export function setFontSize(entry: IEntry) {
  useStorage("ocr4all/frontend/a11n/font-size", entry);
  document.documentElement.style.setProperty("--base-font-size", entry.value);
}
...
export function setGrayscale(entry: IEntry) {
  ...
  document.documentElement.style.setProperty("--grayscale-filter", entry.value);
}
